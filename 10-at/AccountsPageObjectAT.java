...
public class AccountsPageObjectAT {
    ...
    public void successfulUserRegistration() throws Exception {
        ...
        String username = "Namawe";
        String name = "Namawe wa username";
        String password = "password1234";
        String address = "ul. Takase Wo 4";
        ...
        assertEquals("Namawe wa username, ul. Takase 10", loggedInUserInfo.getUserInformation());
    }
}
